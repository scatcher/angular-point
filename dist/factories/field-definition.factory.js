...
var formatted_field_value_service_1 = require('../services/formatted-field-value.service');
...
var FieldDefinition = (function () {
    function FieldDefinition(obj) {
        ...
        this.displayName = this.displayName ? this.displayName : utility_service_1.fromCamelCase(this.mappedName);
    ...
    FieldDefinition.prototype.getDefaultValueForType = function () {
        return field_service_1.getDefaultValueForType(this.objectType);
    };
    /**
     * @ngdoc function
    ...
    FieldDefinition.prototype.getFormattedValue = function (listItem, options) {
        ...
        return lodash_1.isFunction(this.formatter) ? this.formatter(listItem, this, options) :
            formatted_field_value_service_1.getFormattedFieldValue(listItem[this.mappedName], this.objectType, options);
    };
    return FieldDefinition;
}());
exports.FieldDefinition = FieldDefinition;
//# sourceMappingURL=field-definition.factory.js.map