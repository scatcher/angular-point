...
(function (ap) {
    ...
    describe('Factory: apListItemVersionFactory', function () {
        ...
        describe('Class VersionHistoryCollection', function () {
            var v1Date = new Date(2014, 10, 9);
            var v2Date = new Date(2014, 11, 1);
            var mockUser2 = { lookupId: 7, lookupValue: 'James Bond' };
            var integerVersions = {
                mappedName: 'integer',
                versions: {
            ...
            var versionHistoryCollection;
            beforeEach(function () { return versionHistoryCollection = new ap.VersionHistoryCollection([integerVersions, booleanVersions], mockModel.factory); });
