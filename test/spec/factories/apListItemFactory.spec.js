...
(function (ap) {
    ...
    describe("Factory: apListItemFactory", function () {
        ...
        var factory, mockModel, mockLookupModel, mockListItem, apCachedXML, $httpBackend, utils;
        beforeEach(inject(function (_apListItemFactory_, _mockModel_, _mockLookupModel_, _$httpBackend_, _apCachedXML_, apMockUtils) {
        ...
        describe('Method: getLookupReference', function () {
            var mockLookupItem, mockLookupReference;
            beforeEach(function () {
        ...
        describe('Method: registerPreDeleteAction', function () {
            ...
            it('prevents delete if validation action returns false', function () {
                unregister = ap.MockListItem.prototype.registerPreDeleteAction(function () {
        ...
        describe('Method: registerPreSaveAction', function () {
            ...
            it('saves if validation action returns true', function () {
                ...
                unregister = ap.MockListItem.prototype.registerPreSaveAction(function () {
                    expect(this).toEqual(mockListItem);
                    return true;
                });
                mockListItem.saveChanges()
        ...
        describe('Method: registerPostSaveAction', function () {
            it('exectues callback after save event', function () {
                ...
                ap.MockListItem.prototype.registerPostSaveAction(function () {
                    expect(this).toEqual(mockListItem);
...
//# sourceMappingURL=../../spec/factories/apListItemFactory.spec.js.map