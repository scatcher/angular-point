...
angular.module('angularPoint')
    .factory('mockLookupModel', function (apModelFactory, apListItemFactory, apDecodeService, mockXMLService) {
        ...
        Lookup.prototype = apListItemFactory.create();
        Lookup.constructor = Lookup;
