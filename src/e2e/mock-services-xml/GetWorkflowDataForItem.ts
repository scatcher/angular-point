export const GetWorkflowDataForItem = `<?xml version="1.0" encoding="utf-8"?>
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"
               xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <soap:Body>
        <GetWorkflowDataForItemResponse xmlns="http://schemas.microsoft.com/sharepoint/soap/workflow/">
            <GetWorkflowDataForItemResult>
                <WorkflowData>
                    <ToDoData></ToDoData>
                    <TemplateData>
                        <Web Title="Widget Home"
                            ...
                            <WorkflowTemplate Name="WidgetApproval" Description=""
                                ...
                                <Metadata>
                                    ...
                                    <Instantiation_FormURI>
                                        <string>
                                            https://sharepoint.mycompany.com/Workflows/WidgetApproval/WidgetApproval.xsn
                                        </string>
                                    </Instantiation_FormURI>
                                </Metadata>
                            </WorkflowTemplate>
