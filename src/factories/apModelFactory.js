...
export default class apModelFactory{
    ...
    searchLocalCache(value, options) {
        ...
        if (opts.propertyPath === 'id') {
            ...
            if (!_.isNumber(searchCache.count) || searchCache.count !== opts.localCache.count() || opts.rebuildIndex) {
                searchCache.indexedCache = this.deepGroup(opts.localCache, opts.propertyPath);
    ...
    deepGroup(object, propertyPath) {
        var group = new DeepGroup(propertyPath);
    ...
    /**
     * @ngdoc function
     * @name apModelFactory:create
     * @methodOf apModelFactory
...
class DeepGroup extends apIndexedCacheFactory.IndexedCache{
    ...
    addEntity(entity) {
        var cache = this;
        var targetProperty = _.deepGet(entity, this._propertyPath);
        if (targetProperty) {
...
export class Model {
     ...
     * </pre>
     */
    executeQuery(queryName, options) {
        var model = this;
     ...
     * </pre>
     */
    getListItemById(entityId, options) {
