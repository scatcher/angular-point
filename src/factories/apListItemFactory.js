...
let apEncodeService = $injector.get('apEncodeService');
...
export class ListItem {
     ...
     */
    getLookupReference(fieldName, lookupId) {
        var listItem = this;
     ...
     */
    getFormattedValue(fieldName, options) {
        var listItem = this;
     ...
     * </pre>
     */
    getFieldVersionHistory(fieldNames) {
        var deferred = $q.defer();
        var promiseArray = [];
        var listItem = this;
        var model = listItem.getModel();
