 ...
 */
export default function apEncodeService(_, apUtilityService, SPServices) {

    this.choiceMultiToString = choiceMultiToString;
    this.createValuePair = createValuePair;
    this.generateValuePairs = generateValuePairs;
    this.stringifySharePointDate = stringifySharePointDate;
    this.stringifySharePointMultiSelect = stringifySharePointMultiSelect;
