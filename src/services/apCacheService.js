import {IndexedCache, apIndexedCacheFactory} from '../factories/apIndexedCacheFactory.js';
...
angular.module('angularPoint').service('apCacheService', apCacheService);
export default $injector.get('apCacheService');
...
class apCacheService{
     ...
     */
    getCachedEntity(listId, entityId) {
     ...
     */
    registerEntity(entity, targetCache) {
    ...
    _removeEntity() {
        var entityContainer = this;
        this.removeEntity(entityContainer.listId, entityContainer.entityId);
    }
     ...
     * @param {number} entityId The entity.id.
     */
    removeEntity(listId, entityId) {
        var modelCache = this.getModelCache(listId, entityId);
...
class EntityContainer{
    constructor(listId, entityId) {
        ...
        self.getEntity = _getEntity;
        self.removeEntity = _removeEntity;
    }
}
